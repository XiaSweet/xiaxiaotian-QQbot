...
with open("lib/clashroyale/mykey.txt") as f:
    ...
    if goodjuan == True:
        ...
        for item in data["items"]:
                if item["donations"] > 449 and item["donationsReceived"] - item["donations"] < 0 and item["role"] == 'member':
                    stat = 1
                    break
                else:
                    pass
            ...
            if item["donations"] > 449 and item["donationsReceived"] - item["donations"] < 0 and item["role"] == 'member':
                ...
                for item in data["items"]:        
                    if item["donations"] > 449 and item["donationsReceived"] - item["donations"] < 0 and item["role"] == 'member':
                        ...
                        print(mem)
            if item["donations"] > 449 and item["donationsReceived"] - item["donations"] > 0:
