...
import subprocess
@on_command('dblwar', aliases=('部落3+1'),only_to_me=True)
...
async def get_dblwar(tag: str) -> str:
    ...
    return f'{dblwar}'
@on_natural_language(keywords={'3+1','大部落部落战','活动查询'},only_to_me=True)
